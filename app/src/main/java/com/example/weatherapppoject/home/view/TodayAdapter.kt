...
class TodayAdapter(private val forecastArray: List<ForeCastData>, private val language :String, private val units: String): RecyclerView.Adapter<TodayAdapter.ViewHolder>() {
